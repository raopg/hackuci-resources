...
4.  [HackUCI Workshop Resources](https://docs.google.com/document/d/1-iE7WgLCERRo6xavmBZDLU2bKegb2CDvTFzyp7J4gKs/edit?usp=sharing)
5.  [Master API directory](https://www.programmableweb.com/category/all/apis)
6.  [Credits](#credits)
...
Highly recommend checking this Github repository, from which this repository was forked. These resources are more general, whereas the current repository has been modified specifically for HackUCI V.
